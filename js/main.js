$(document).ready(function(){
  ...
  $(window).scroll(function(){
	...
	function initialize() {
	  var myLatlng = new google.maps.LatLng(10.4535884,-73.2676788);
	  var mapOptions = {
	    zoom: 17,
	    center: new google.maps.LatLng(10.4535884,-73.2676788),
	  ...
	  var marker = new google.maps.Marker({
	    position: myLatlng,
	    map: map,
	    title: 'Institución Educativa José Eugenio Martínez'
	  });
	}
